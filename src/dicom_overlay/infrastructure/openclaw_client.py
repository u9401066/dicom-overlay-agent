...
def _build_finalization_prompt(
    *,
    ...
    return (
        ...
        "- Serialize compact JSON without indentation. Summary <=35 words, each "
        "finding detail <=30 words, each reviewer question <=18 words, each "
        "checklist value <=12 words, and at most three next_steps. Keep all 16 "
        "required EKG checklist axes; shorten wording, never omit an axis.\n"
        "- Return layout={} in this final turn. The app preserves the already "
        "verified draft layout unchanged; do not regenerate its lead coordinates "
        "or explanatory notes. This does not relax finding bbox validation.\n"
